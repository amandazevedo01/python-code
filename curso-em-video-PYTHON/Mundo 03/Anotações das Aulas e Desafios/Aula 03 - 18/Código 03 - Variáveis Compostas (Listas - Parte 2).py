...
galera.append(teste[:])  # Adiciona uma cópia da lista "Mundo 3 - Continuaçao" (e não a própria lista) à lista composta "galera"
...
galera.append(teste[:])  # Adiciona novamente uma cópia da lista "Mundo 3 - Continuaçao" (já modificada) à lista composta "galera"
